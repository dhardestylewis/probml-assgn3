...
\begin{frame}{}
  ...
  \begin{columns}[t]
    ...
    % --- COLUMN 2 ---
    \begin{column}{0.31\paperwidth}
      \begin{block}{Spatial Residual Analysis}
        Spatial plotting reveals geographic bias.
        \begin{figure}
          \centering
          \includegraphics[width=0.95\textwidth]{images/residuals_spatial_map.png}
          \caption{Spatial Residuals. Color indicates mean residual per hexbin.}
        \end{figure}
      \end{block}
      ...
      \begin{block}{Residual Analysis}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.8\textwidth]{images/residuals_hist_references.png}
          % QQ plot removed to simplify visual narrative and fix build stability.
          % \includegraphics[width=0.48\textwidth]{images/residuals_qq_simple.png}

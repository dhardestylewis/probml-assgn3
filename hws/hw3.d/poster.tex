  ...
  \begin{beamercolorbox}[wd=\paperwidth]{headline}
    \begin{columns}[T]
      ...
      \begin{column}{.15\paperwidth}
        \centering
        \vspace{1cm}
        \includegraphics[height=7cm]{images/columbia_logo.png} 
        \vspace{1cm}
      \end{column}
      ...
      \begin{column}{.15\paperwidth}
        \centering
        \vspace{1.5cm}
        \includegraphics[height=6cm]{images/columbia_engineering_logo.png}
        \vspace{1.5cm}
      \end{column}
      \begin{column}{.02\paperwidth}\end{column}
    \end{columns}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.31\paperwidth}
      ...
      \begin{block}{Graphical Model}
        \begin{figure}
          \centering
          \includegraphics[width=0.95\textwidth]{images/miwae_graphical_model.png}
    ...
    \begin{column}{0.31\paperwidth}
      ...
      \begin{block}{Residual Analysis}
        Spatial plotting reveals bias, while histogram confirms heavy tails (Kurtosis $\approx 9.27$).
        \begin{figure}
          \centering
          ...
          \caption{Spatial Residuals (Left) and Log-price Residual Distribution (Right).}
        \end{figure}
      \end{block}
    \end{column}
    ...
    \begin{column}{0.31\paperwidth}
      \begin{block}{Latent Space Analysis}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.9\textwidth]{images/latent_space_price.png}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.9\textwidth]{images/latent_space_bldg.png}
      ...
      \begin{block}{Discussion \& Future Work}
        \begin{itemize}
          \item \textbf{Findings}: Latents organize properties by value type, but Gaussian head misses tails ($R^2 \approx 0.27$ on residuals).
            \begin{center}

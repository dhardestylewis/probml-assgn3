  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.31\paperwidth}
      \begin{block}{Convergence \& Training}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.9\textwidth]{miwae_loss_elbo.png}
      ...
      \begin{block}{Residual Analysis}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.48\textwidth]{miwae_residuals_histogram.png}
          \hfill
          \includegraphics[width=0.48\textwidth]{miwae_residuals_qq.png}
    ...
    \begin{column}{0.31\paperwidth}
      \begin{block}{Latent Space Analysis}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.9\textwidth]{miwae_latents_by_sale_price.png}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.9\textwidth]{miwae_latents_by_building_class.png}
